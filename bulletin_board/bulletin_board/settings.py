...
SECRET_KEY = 'django-insecure-mc1_10n84c44mb@c9s6)3!o8_uvu-#g1s-z)73u$=wwt$14^2='
...
LOGIN_REDIRECT_URL = '/'                 # 로그인 후 리다이렉트될 URL (게시판 페이지)
LOGOUT_REDIRECT_URL = '/accounts/login/' # 로그아웃 후 리다이렉트될 URL
